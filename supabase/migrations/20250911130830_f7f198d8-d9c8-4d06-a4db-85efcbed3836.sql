-- Add more daily missions for variety and engagement (using correct column name)
INSERT INTO public.daily_missions (id, title, description, mission_type, target_count, reward_points, is_active) VALUES
